...
class Reservation {
  ...
  //methods for getting and setting number of guests
  ...
  // methods for setting/getting startAt tiem
  ...
  //methods for setting and getting notes
  ...
  //methods for setting and getting customer ID
